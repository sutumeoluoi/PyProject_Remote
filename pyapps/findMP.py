...
from BasicInterface import BasicDBOut
from Filedefs import CellActCmp
from SqldataRetrieve import SqlRetrieve, SqlRetrieveThreading
...
basic_dbout()   #class BasicDBOut is callable, but its instance basic_dbout NOT callable. 
                #However, I implemented __call__ in it, so instance is now callable
